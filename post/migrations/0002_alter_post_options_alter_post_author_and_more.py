# Generated by Django 6.0.5 on 2026-05-11 15:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='status',
            field=models.CharField(choices=[('PB', 'انتشار'), ('DF', 'پیش نویس'), ('RJ', 'رد شده')], default='DF', max_length=2, verbose_name='وضعیت'),
        ),
        migrations.AlterField(
            model_name='post',
            name='title',
